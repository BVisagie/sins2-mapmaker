...
export const BODY_TYPES: BodyType[] = [
	...
	{ id: 'planet_brown_dwarf', label: 'Brown Dwarf (Special)', category: 'planet', radius: 16, color: '#8b5cf6' },
	...
	{ id: 'asteroid_hive', label: 'Hive Asteroid (Fixture)', category: 'asteroid', radius: 12, color: '#34d399' },
